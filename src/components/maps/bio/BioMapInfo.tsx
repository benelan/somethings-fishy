    ...
    <InfoItem>
      <CalciteCard>
        ...
        <ul>
          ...
          <li>
            The Natural Resources Defense Council (NRDC) published an article in 2019 detailing that
            overfishing in the ocean had the single greatest impact on biodiversity in the last 50
            years.
          </li>
          <li>It is important that sustainable fishing and food production is taken seriously.</li>
        </ul>
      </CalciteCard>
    </InfoItem>
    <InfoItem>
      <CalciteCard>
        ...
        <p>
          Measuring biodiversity comes down to species richness and evenness. Richness is a measure
          of how many organisms exist in a specific area. Evenness measures the number of species
          and the relative abundance of species in a specific area or community. Measuring
          biodiversity can become very complex and difficult to accurately measure. Therefore,
          scientists rely on using an index based on the abundance of species that returns a single
          number to represent both richness and abundance. Using an index makes it easier to compare
          diversity among two or more communities of species.
        </p>
      </CalciteCard>
    </InfoItem>
    <InfoItem>
      <CalciteCard>
        ...
        <ul>
          ...
          <li>
            ...
            because all the living organism in the community belong to the same species. The higher
            the value of H, the more diverse the community is (webpages.uidaho.edu).
          </li>
        </ul>
      </CalciteCard>
    </InfoItem>
    ...
    <InfoItem>
      <CalciteCard>
        ...
        <p>
          ...
          Shannon-Wiener Index formula. The app is simple and easy to use and helps illustrate some
          of the work scientists do when comparing species diversity. It is intended to allow the
          user to feel like they are scientists on the field comparing species evenness. The app
          also has some great information on actual species in the Gulf of Mexico with links to the
          NOAA website. It allows users to add more living organism onto the map with some editing
          features.
        </p>
      </CalciteCard>
    </InfoItem>
